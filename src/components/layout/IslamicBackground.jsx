...
export default function IslamicBackground({ children, variant = 'default' }) {
  const variants = {
    default: 'from-indigo-950/90 via-slate-900/95 to-slate-950/98 dark:from-slate-950/95 dark:via-slate-900/98 dark:to-black/98',
    emerald: 'from-emerald-950/90 via-slate-900/95 to-slate-950/98 dark:from-emerald-950/95 dark:via-slate-900/98 dark:to-black/98',
    purple: 'from-purple-950/90 via-slate-900/95 to-slate-950/98 dark:from-purple-950/95 dark:via-slate-900/98 dark:to-black/98',
    amber: 'from-amber-950/90 via-slate-900/95 to-slate-950/98 dark:from-amber-950/95 dark:via-slate-900/98 dark:to-black/98',
  };

  return (
    <div className="min-h-screen relative bg-white dark:bg-slate-950" dir="rtl">
